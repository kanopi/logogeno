...
if __name__ == "__main__":
    ...
    parser.add_argument("--platform", required=True, choices=["Saplings", "Arbor", "Shrubs"], help="The branding platform (Saplings or Arbor).")
